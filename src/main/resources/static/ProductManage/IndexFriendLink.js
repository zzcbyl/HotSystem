...
(function () {
    ...
    $(function () {
        ...
        _$form.find('.submit').click(function (e) {
            ...
            product.ProductNameCN = product.DescriptionCN;
        ...
        function EditProduct(product)
        {
            _$modal.off('show.bs.modal').on('show.bs.modal', function () {
                ...
                _$modal.find("input[name='DescriptionCN']").val(product.descriptionCN);
                _$modal.find("input[name='DescriptionEN']").val(product.descriptionEN);
                _$modal.find("input[name='DescriptionKR']").val(product.descriptionKR);
