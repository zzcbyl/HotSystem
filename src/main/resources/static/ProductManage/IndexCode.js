...
(function () {
    ...
    $(function () {
        ...
        $("#btnAddProduct").on("click", function () {
            ...
            editorInstances.setEditorValue('DescriptionCN', '');
            editorInstances.setEditorValue('DescriptionEN', '');
            editorInstances.setEditorValue('DescriptionKR', '');
        ...
        function EditProduct(product)
        {
            _$modal.off('show.bs.modal').on('show.bs.modal', function () {
                ...
                editorInstances.setEditorValue('DescriptionCN', product.descriptionCN);
                editorInstances.setEditorValue('DescriptionEN', product.descriptionEN);
                editorInstances.setEditorValue('DescriptionKR', product.descriptionKR);
            });
            _$modal.modal("show");
        }
...
$(function () {
    editorInstances.createEditor('DescriptionCN','toolbarCN');
    editorInstances.createEditor('DescriptionEN','toolbarEN');
    editorInstances.createEditor('DescriptionKR','toolbarKR');
    //$('#DescriptionCN').wysihtml5();
    //$('#DescriptionEN').wysihtml5();
    //$('#DescriptionKR').wysihtml5();
    //初始化编辑器
    //editorInstances.createEditor('Description');
});

function insertImage(language) {
    showEditorImageUploadForm(language);
...
function hideMenu(menuID) {
    ...
    //打开编辑器插入图片窗口
    function showEditorImageUploadForm(language) {
      
        $("#UploadImageModal").modal("show");
        $("#UploadImageModal #uploadImgBtn").off("click").on("click",function (e) {
            uploadImg(e, function (imgUrl) { editorInstances.insertImageEx('Description' + language, imgUrl); });
        });
    }
