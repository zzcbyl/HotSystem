...
<head>
    ...
    <title>画图测试</title>
   <#include "admin/shared/cssFile.ftl" />
...
<script src="/js/three/effects/ParallaxBarrierEffect.js"></script>
<script src="/js/three/loaders/BinaryLoader.js"></script>
...
<script>
    ...
    function init() {
        ...
        var textureCube = new THREE.CubeTextureLoader()
                .setPath( '/js/three/textures/cube/Bridge2/')
