...
import com.fastrun.TempCollection.service.ServiceRecordService
...
class ServiceRecordController {
    @Resource
    var _service: ServiceRecordService? = null
    ...
    fun get(@RequestParam id: Int): ResponseData {
        val re = ResponseData()
        var result: ServiceRecord? = _service?.get(id)
    ...
    @PostMapping("create")
    @ResponseBody
    fun create(@RequestBody model: ServiceRecord): ResponseData {
        val re = ResponseData()
    ...
    @GetMapping("update")
    @ResponseBody
    fun update(@RequestBody model: ServiceRecord): ResponseData {
        val re = ResponseData()
    ...
    fun list(): ModelAndView {
        var m = ModelAndView()
        m.viewName = "/admin/serviceRecord/list"
        return m;
    }
