...
import com.fastrun.TempCollection.service.RoomService
...
class RoomController {
    ...
    {
        val re =ResponseData()
        var result:Room?=_service?.get(id)
    ...
    @PostMapping("create")
    @ResponseBody
    fun create(@RequestBody model: Room):ResponseData
    {
        val re =ResponseData()
    ...
    @PostMapping("update")
    @ResponseBody
    fun update(@RequestBody model: Room):ResponseData
    {
        val re =ResponseData()
